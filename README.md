...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/dados_pt_search_datasets \
  -H 'Content-Type: application/json' \
  -d '{"query":"saúde pública COVID-19","page":1,"page_size":20,"sort":"-created"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/dados_pt_search_datasets`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
